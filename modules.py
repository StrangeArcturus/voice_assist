...
class Translation:
    ...
    "Listening...": {
      ...
      "Relative to your device, time is now": {
      "ru": "Относительно Вашего устройства, время сейчас",
      "en": "Relative to your device, time is now"
    },
    "Now is": {
      "ru": "Сейчас",
      "en": "Now is"
    ...
    "Okey, I'll start to you again and answering in 10 minutes": {
      "ru": "О'кей, я начну снова слушать вас и отвечать через 10 минут, не буду отвлекать вас",
      "en": "Okey, I'll start to you again and answering in 10 minutes"
    },
    "Sure, the best people is Viktoria!": {
      "ru": "Конечно же, самый лучший человек это Виктория!",
      "en": "Sure, the best people of the world is Viktoria!"
    },
    "Glad to serve": {
      "ru": "Рада служить",
      "en": "Glad to serve"
